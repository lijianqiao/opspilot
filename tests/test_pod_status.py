...
def test_get_pod_status_default_namespace_lists_pods() -> None:
    """
    Verify get pod status default namespace lists pods.

    验证：get pod status default namespace lists pods。
    """
...
def test_get_pod_status_filters_by_namespace() -> None:
    """
    Verify get pod status filters by namespace.

    验证：get pod status filters by namespace。
    """
...
def test_get_pod_status_unknown_namespace() -> None:
    """
    Verify get pod status unknown namespace.

    验证：get pod status unknown namespace。
    """
